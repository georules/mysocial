...
<li>That you have created your "users" table correctly.  (userID, username, password, picture) fields have all been made and are the right CASE (e.g. ID is in caps for userID.)</li>
...
<li>That your password field on the database is VARCHAR(60).  This field needs to be at least 60 long, not just 30, so that the entire password hash can be stored properly.  You will need to remove all users that you made previously if you did not have the password field set to VARCHAR(60). </li></ol><?php
        echo "<a href = 'user_form.php'>Please try again</a>";
